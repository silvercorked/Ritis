...
namespace engine {
	...
	auto Pipeline::createGraphicsPipeline(
		...
		vertexInputInfo.vertexAttributeDescriptionCount = 0;						// temp = 0, as triangle is hard coded
		vertexInputInfo.vertexBindingDescriptionCount = 0;							// temp = 0, as triangle is hard coded
